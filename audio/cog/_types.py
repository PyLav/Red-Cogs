...
if TYPE_CHECKING:
    ...
    from audio.cog import HybridCommands, MediaPlayer, PlaylistCommands, UtilityCommands, PlayerCommands  # noqa: F401
    from audio.cog.menus.sources import PlaylistListSource  # noqa: F401
    from redbot.core.utils import menus  # noqa: F401

    Cog = Union[MediaPlayer, HybridCommands, PlaylistCommands, UtilityCommands, PlayerCommands, Cog, CogMixin]
